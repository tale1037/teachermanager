...
public interface TeacherMapper {
    ...
    // 新增教师信息
    @Insert("INSERT INTO teacher(name, department, title, email, researchArea, officeAddress, score) " +
            "VALUES (#{name}, #{department}, #{title}, #{email}, #{researchArea}, #{officeAddress}, #{score})")
