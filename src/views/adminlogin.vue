        ...
        <el-col :span="6" :offset="3" class="form">
            ...
            <el-form ref="form" size="large" autocomplete="off" v-if="isRegister" :model="registerData" :rules="rules">
                ...
                <el-form-item prop="rePassword" v-else>
                    <el-input :prefix-icon="Lock"  placeholder="请输入您的年级"
                        v-model="registerData.grade"></el-input>
                </el-form-item>
                <el-form-item prop="rePassword" v-if="registerData.isTeacher">
            ...
            <el-form ref="form" size="large" autocomplete="off" v-else :model="registerData" :rules="rules">
                ...
                <!-- 登录按钮 -->
                <el-form-item>
                    <el-button class="button" type="primary" auto-insert-space @click="login1">登录</el-button>
                </el-form-item>
                <el-form-item class="flex">
