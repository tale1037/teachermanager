...
<template>
    <el-card class="page-container">
        ...
        <el-table :data="articles" style="width: 100%">
            <el-table-column label="申请人" width="400" prop="title"></el-table-column>
            <el-table-column label="时间" prop="categoryName"></el-table-column>
            <el-table-column label="日期" prop="createTime"> </el-table-column>
            <el-table-column label="申请时间" prop="state"></el-table-column>
